...
#define InstallerIni = SourcePath + "installer.ini"
#define AppName ReadIni(InstallerIni, "Settings", "AppName")
#define SourceDir ReadIni(InstallerIni, "Settings", "SourceDir")
#define OutputDir ReadIni(InstallerIni, "Settings", "OutputDir")
#define AppPublisher ReadIni(InstallerIni, "Settings", "AppPublisher")
#define AppPublisherURL ReadIni(InstallerIni, "Settings", "AppPublisherURL")
#define AppSupportURL ReadIni(InstallerIni, "Settings", "AppSupportURL")
#define AppUpdatesURL ReadIni(InstallerIni, "Settings", "AppUpdatesURL")
#define OutputBaseFilename ReadIni(InstallerIni, "Settings", "OutputBaseFilename")
#define SetupIconFile ReadIni(InstallerIni, "Settings", "SetupIconFile")
#define LicenseFile ReadIni(InstallerIni, "Settings", "LicenseFile")

#define AppVersion = ReadIni(SourceDir  + "\version", "DTA", "Version")
...
#sub ProcessExecFile
  ...
  #for {ExecFileHandle = FileOpen("..\..\package\" + ExecFileName); \
